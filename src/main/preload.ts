...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  ai: {
    ...
    // Thread API関連
    createThread: (metadata?: any) => ipcRenderer.invoke('ai:createThread', metadata),
  ...
  search: {
    ...
    hybrid: (query: string, options?: any) => ipcRenderer.invoke('search:hybrid', query, options),
  ...
  // Anything Box関連
  anythingBox: {
    process: (input: any) => ipcRenderer.invoke('anythingBox:process', input),
    history: (options?: any) => ipcRenderer.invoke('anythingBox:history', options),
  },

  // エージェントシステム関連
  agents: {
    create: (options: any) => ipcRenderer.invoke('agents:create', options),
    startDiscussion: (options: any) => ipcRenderer.invoke('agents:startDiscussion', options),
    ...
    requestWritingSuggestions: (context: any) =>
